...
# ---------------------------------------------------------------------------
# Universal safety prefix prepended to EVERY agent's instructions.
# Prevents agents from hallucinating actions their tools don't support,
# refusing destructive operations when no tool exists, and staying within
